...
<head>
    ...
    <style>
        ...
        .login-card { background: white; border-radius: 15px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); max-width: 450px; width: 100%; }
...
<body>
    <div class="login-card">
        <div class="login-header">
            ...
            <p class="mb-0 mt-2">Join Hospitality CRM</p>
        </div>
        <div class="login-body">
            <form method="POST" action="{{ route('auth.register') }}">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary"><i class="bi bi-person-plus me-2"></i>Register</button>
                </div>
            </form>
            <hr>
